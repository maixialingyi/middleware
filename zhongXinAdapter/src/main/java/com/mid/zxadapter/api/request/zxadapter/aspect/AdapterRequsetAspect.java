package com.mid.zxadapter.api.request.zxadapter.aspect;

import com.alibaba.fastjson.JSON;
import com.mid.zxadapter.api.request.zxadapter.api.request.AbstractRequest;
import com.mid.zxadapter.api.request.zxadapter.api.request.Request;
import com.mid.zxadapter.api.request.zxadapter.api.request.RequestFactory;
import com.mid.zxadapter.api.request.zxadapter.utils.BeanUtil;
...
public class AdapterRequsetAspect {
    ...
    @Around(value = "@annotation(com.mid.zxadapter.api.request.zxadapter.aspect.AdapterRequset)")
