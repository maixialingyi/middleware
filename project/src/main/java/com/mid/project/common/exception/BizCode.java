...
public enum BizCode{
    ...
    SUCCESS("0100", "成功"),
    ERROR("0101", "系统异常"),
    PARAMETER_VERIFICATION("0102", "请求参数非法"),
    USER_DOES_NOT_EXIST("0103", "用户不存在"),

    DEDUCT_PROCESSING("0141", "自动还款进行中，敬请等待或者60分钟后再次进行还款尝试"),
    REPAY_TRADE_CREATE_ERROR("0144", "生成还款交易失败"),
    REPAY_DATA_PROCESS_ERROR("0149", "数据处理异常"),
    REPAY_BILL_NOT_FOUND_ERROR("0155", "还款交易单不存在"),
     ...
     * 买单分期是否可用新增code
     */
    LECHECK_INSTALLMENT_AVAILABLE_OK("0738", "买单交易分期可用"),
    LECHECK_INSTALLMENT_RISK_REJECT("0739", "暂不支持使用分期支付-风控拒绝"),
    LECHECK_INSTALLMENT_LOWER_LIMIT_NOT_SATISFIED("0740", "订单金额不满足分期要求"),
    LECHECK_INSTALLMENT_CALCULATE_ERROR("0741", "暂不支持使用分期支付-分期金额计算失败"),
    LECHECK_INSTALLMENT_DISABLED("0742", "暂不支持使用分期支付-功能禁用"),
